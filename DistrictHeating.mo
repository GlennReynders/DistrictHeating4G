...
<p>See the <a href=\"modelica://IDEAS.Thermal.HeatingSystems.Examples\">heating system examples</a>. </p>
    ...
    model Building
      ...
      Modelica.Fluid.Interfaces.FluidPort_a port_a(redeclare package Medium =
            Modelica.Media.Examples.TwoPhaseWater) if DH
        annotation (Placement(transformation(extent={{-26,-110},{-6,-90}})));
      Modelica.Fluid.Interfaces.FluidPort_b port_b(redeclare package Medium =
            Modelica.Media.Examples.TwoPhaseWater) if DH annotation (Placement(
    ...
    //       smooth=Smooth.None));
      ...
      if ventilationSystem.nLoads >=1 then
      ...
      if heatingSystem.nLoads >=1 then
